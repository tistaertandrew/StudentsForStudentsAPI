...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221102144911_init')
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Sections] ([Id], [Label])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Cursus] ([Id], [Label], [SectionId])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221102210618_ajout-valeurs-sections-et-cursus')
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Label') AND [object_id] = OBJECT_ID(N'[Sections]'))
        SET IDENTITY_INSERT [Sections] ON;
    EXEC(N'INSERT INTO [Sections] ([Id], [Label])
